...
|---------|-------------|-------|
| [Swift AI Agent Core](https://github.com/VDurocher/Swift-AI-Agent-Core) | Swift 6 package for integrating LLM agents into iOS/macOS apps — streaming, retry, SwiftData persistence, zero dependencies | Swift |
